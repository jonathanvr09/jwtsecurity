...
public class JwtUtilImpl implements JwtUtil {
    ...
    public String generateToken(UserDetails userDetails,
        ...
        claims.put("name", ((UsuarioModel) userDetails).getNombre());
        claims.put("lastName", ((UsuarioModel) userDetails).getApellido());
        claims.put("rol", ((UsuarioModel) userDetails).getRole());
